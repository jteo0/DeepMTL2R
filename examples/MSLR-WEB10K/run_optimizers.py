...
def run_optimizer_experiment(experiment_choice, checkpoint_path, dataset_path, train_dataloader, val_dataloader, n_features):
...
def main():
    ...
    for fold in FOLDS:
        ...
        run_optimizer_experiment(choice, checkpoint_path, dataset_path, train_dl, val_dl, nf)
